...
class ScreenAnalysis:
    ...
    STAGING_URL = f"file:\\{os.path.abspath(os.getcwd())}\\tests\\staging.html"
    PRODUCTION_URL = f"file:\\{os.path.abspath(os.getcwd())}\\tests\\production.html"
    driver = None
    ...
    def screenshot(self, url, file_name):
        ...
        self.driver.save_screenshot(
            os.path.join(
                os.path.dirname(os.path.realpath(__file__)), "screenshots", file_name
            )
        )
